...
**iPhone 6.9" is DONE** — `docs/apple-port/screenshots/6.9/plated/`, 12 images at **1320×2868**, generated by `scripts/caption-screenshots.py` from captures taken on an iPhone 17 Pro Max.

> ⚠ The earlier set in `screenshots/` is **1206×2622** (iPhone 17 Pro, 6.3"), which App Store Connect does not accept for any iPhone slot — it would have been rejected at upload. The iPad set is 1668×2420 (13" needs 2064×2752 or 2048×2732) and the Mac set 1520×1640 (needs 1280×800, 1440×900, 2560×1600 or 2880×1800). **iPad and Mac still need re-capturing at accepted sizes.**
